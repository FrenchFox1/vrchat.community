---
title: World tags
description: Author assigned search tags, content warnings, and admin-assigned feature flags for worlds.
---
...
| `admin_approved`                                |
| `admin_avatar_world`                            |
| `admin_alternate_size_limits`                   |
| `admin_community_spotlight`                     |
| `admin_disable_avatar_collision`                |
...
Worlds can also have a range of different event-specific tags such as `admin_vrrat_community_takeover` for the Vket row, `admin_muzzfesst` for the MUZZFEST event, or `admin_halloween_2019` for the 2019 Halloween row. These are not exhaustively listed because it would be impossible to accurately keep such list up-to-date, and each tag is of little use outside of that specific event.

| Tag                                  | Description      |
| ------------------------------------ | ---------------- |
| `admin_community_pjkt_graffiti_grab` | Graffiti Grab    |
| `admin_graffiti_grab_2026`           | Graffiti Grab    |
| `admin_halloween_2019`               | Spookality       |
| `admin_muzzfesst`                    | Muzzfest         |
| `admin_spacejam25_nhsf`              | Space Jam        |
| `admin_spookality_2024_featured`     | Spookality       |
| `admin_spookality_2024_showcase`     | Spookality       |
| `admin_touch_grass`                  | April Fool's Day |
| `admin_vrrat_community_takeover`     | April Fool's Day |
| `admin_pride2026`                    | Pride 2026       |
| `admin_tanabata2026`                 | Tanabata 2026    |
