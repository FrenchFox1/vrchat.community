---
title: User tags
description: Trust ranks, access to features, and other metadata about users.
---
...
| `permission-upload-props`                              | User can upload props                                                                                                                                  |
| `permission-test-props`                                | User can test uploaded props                                                                                                                           |
| `permission-platform-ios`                              | Unknown                                                                                                                                                |
