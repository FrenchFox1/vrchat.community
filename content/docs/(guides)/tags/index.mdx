...
<Cards>
  <Card href="/tags/user" title="User tags" icon={<UserIcon />}>
    Trust ranks, access to features, and other metadata about users.
  </Card>
  <Card href="/tags/world" title="World tags" icon={<GlobeIcon />}>
    Author assigned search tags, content warnings, and admin-assigned feature flags for worlds.
  </Card>
  <Card href="/tags/group" title="Group tags" icon={<LandPlot />}>
    Admin-assigned feature flags for groups.
  </Card>
</Cards>
...
| `system_system_system_system_system_system_system`                                                                                                                                                                    | Meaningless tag used by Squid                                                   |
| `😈`                                                                                                                                                                                                                  | Meaningless tag used by Squid                                                   |
...
| `system_is_down`                                                                                                                                                                                                      | Meaningless tag used by monadic                                                 |
| ` admin_gift_drop_ineligible`                                                                                                                                                                                         | Meaningless tag used by Faxmashine                                              |
| `Internal Beta Subscription`                                                                                                                                                                                          | Meaningless tag used by MomoTheMonster                                          |
| `my tail is prettier than yours`                                                                                                                                                                                      | Meaningless tag used by Sai                                                     |
| `system_trust_yorha_sai`                                                                                                                                                                                              | Meaningless tag used by Sai                                                     |
| `system_filthy_casual`                                                                                                                                                                                                | Meaningless tag used by Sai                                                     |
| `system_info_cult`                                                                                                                                                                                                    | Meaningless tag used by Nayir                                                   |
| `system_why_are_you_reading_these_lol`                                                                                                                                                                                | Meaningless tag used by Nayir                                                   |
| `system_gremlin`                                                                                                                                                                                                      | Meaningless tag used by Tizzy
